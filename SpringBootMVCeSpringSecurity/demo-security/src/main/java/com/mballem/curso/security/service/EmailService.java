...
public class EmailService {
    ...
    @Autowired
    private static SpringTemplateEngine template;

    public static void enviarPedidoDeConfirmacaoDeCadastro(String destino, String codigo) throws MessagingException{
        ...
        helper.setFrom("não-responda@clinica.com.br");
    ...
    public static void enviarPedidoDeRedefinicaoDeSenha(String destino, String verificador) throws MessagingException{
        MimeMessage message = mailSender.createMimeMessage();
        MimeMessageHelper helper = 
            new MimeMessageHelper(message, MimeMessageHelper.MULTIPART_MODE_MIXED_RELATED, "UTF-8");
